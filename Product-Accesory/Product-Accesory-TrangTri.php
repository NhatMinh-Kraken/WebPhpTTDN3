...
<?php
    $sql_quanly_trangtri = "SELECT * FROM chitietphukien, loaiphukientrangtri WHere chitietphukien.IdLoaiPhuKienTrangTri = loaiphukientrangtri.IdLoaiPhuKienTrangTri and chitietphukien.IdLoaiPhuKienTrangTri = '$_GET[idchitietphukien]' Order by IdChiTietPhuKien DESC LIMIT 6";
    $query_quanly_trangtri = mysqli_query($mysqli,$sql_quanly_trangtri);
        ...
        <div class="row">
            ...
            <div class="row-accesory">
                <div class="row-body-accesory">
                    <?php
                    while($row = mysqli_fetch_array($query_quanly_trangtri))
                    {
                    ?>
