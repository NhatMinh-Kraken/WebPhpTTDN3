...
<?php
    $sql_quanly_tiennghi = "SELECT * FROM chitietphukien, loaiphukientiennghi WHere chitietphukien.IdLoaiPhuKienTienNghi = loaiphukientiennghi.IdLoaiPhuKienTienNghi and chitietphukien.IdLoaiPhuKienTienNghi = '$_GET[idchitietphukien]' Order by IdChiTietPhuKien DESC LIMIT 6";
    $query_quanly_tiennghi = mysqli_query($mysqli,$sql_quanly_tiennghi);
        ...
        <div class="row">
            ...
            <div class="row-accesory">
                <div class="row-body-accesory">
                    <?php
                    while($row = mysqli_fetch_array($query_quanly_tiennghi))
                    {
                    ?>
