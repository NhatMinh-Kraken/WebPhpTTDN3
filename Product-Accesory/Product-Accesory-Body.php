...
<?php
    $sql_quanly_body = "SELECT * FROM chitietphukien, loaiphukienbody WHere chitietphukien.IdLoaiPhuKienBody = loaiphukienbody.IdLoaiPhuKienBody and chitietphukien.IdLoaiPhuKienBody = '$_GET[idchitietphukien]' Order by IdChiTietPhuKien DESC LIMIT 6";
    $query_quanly_body = mysqli_query($mysqli,$sql_quanly_body);
        ...
        <div class="row">
            ...
            <div class="row-accesory">
                <div class="row-body-accesory">
                    <?php
                    while($row = mysqli_fetch_array($query_quanly_body))
                    {
                    ?>
