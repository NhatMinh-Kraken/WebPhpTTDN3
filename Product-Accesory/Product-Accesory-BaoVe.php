...
<?php
    $sql_quanly_baove = "SELECT * FROM chitietphukien, loaiphukienbaove WHere chitietphukien.IdLoaiPhuKienBaoVe = loaiphukienbaove.IdLoaiPhuKienBaoVe and chitietphukien.IdLoaiPhuKienBaoVe = '$_GET[idchitietphukien]' Order by IdChiTietPhuKien DESC LIMIT 6";
    $query_quanly_baove = mysqli_query($mysqli,$sql_quanly_baove);
        ...
        <div class="row">
            ...
            <div class="row-accesory">
                <div class="row-body-accesory">
                    <?php
                    while($row = mysqli_fetch_array($query_quanly_baove))
                    {
                    ?>
