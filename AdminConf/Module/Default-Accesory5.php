<?php
    ...
    $sql_lietke_chitietphukien = "SELECT * FROM chitietphukien, loaiphukienmamxe WHere chitietphukien.IdLoaiPhuKienMamXe = loaiphukienmamxe.IdLoaiPhuKienMamXe and IdChiTietPhuKien='$_GET[idaccesory]'";
