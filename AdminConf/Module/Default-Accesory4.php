<?php
    ...
    $sql_lietke_chitietphukien = "SELECT * FROM chitietphukien, loaiphukientrangtri WHere chitietphukien.IdLoaiPhuKienTrangTri = loaiphukientrangtri.IdLoaiPhuKienTrangTri and IdChiTietPhuKien='$_GET[idaccesory]'";
