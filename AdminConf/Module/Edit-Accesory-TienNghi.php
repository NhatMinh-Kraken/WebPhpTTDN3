                        ...
                        <div class="form-group padding">
                            <div class="Name-Product-Car">
                                ...
                                <select id="loaiphukien" name="loaiphukien" class="form-control">
                                    ...
                                    <?php
                                        include('config.php');
                                        $sql = "SELECT IdLoaiPhuKienTienNghi, TenLoaiPhuKienTienNghi FROM loaiphukientiennghi"; 
                                        ...
                                        if($num > 0){
                                            ...
                                            {   
                                    ?>
                                    <option value="<?php echo $row1['IdLoaiPhuKienTienNghi'] ?>">
                                        <?php echo $row1['TenLoaiPhuKienTienNghi'] ?></option>
                                    <?php
                                            }
                                        }
                                    ?>
