<?php
    ...
    $sql_lietke_chitietphukien = "SELECT * FROM chitietphukien, loaiphukienbaove WHere chitietphukien.IdLoaiPhuKienBaoVe = loaiphukienbaove.IdLoaiPhuKienBaoVe and IdChiTietPhuKien='$_GET[idaccesory]'";
