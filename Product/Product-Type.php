<?php
    $sql_xe = "SELECT * FROM chitietsanpham, loaixe WHere chitietsanpham.IdLoaiXe = '$_GET[idchitietxe]' and chitietsanpham.IdLoaiXe = loaixe.IdLoaiXe Order by idchitietsanpham DESC LIMIT 6";
